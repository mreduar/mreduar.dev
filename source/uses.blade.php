...
<section>
    ...
    <div class="mt-10">
        ...
        <ul class="list-none pl-5">
            ...
            <li><a href="https://laravel-livewire.com" target="_blank" rel="noopener noreferrer">Livewire</a></li>
            ...
            <li>HTML5, CSS3, SASS, <a href="https://tailwindcss.com/" target="_blank" rel="noopener noreferrer">Tailwind
                    CSS</a>, <a href="https://getbootstrap.com" target="_blank" rel="noopener noreferrer">Bootstrap
                    4</a>
            </li>
            <li>JavaScript, <a href="https://jquery.com/" target="_blank" rel="noopener noreferrer">JQuery</a>, <a
                    href="https://vuejs.org/" target="_blank" rel="noopener noreferrer">VueJS</a>
            </li>
            <li><a href="https://getcomposer.org" target="_blank" rel="noopener noreferrer">Composer</a> & <a
    ...
    <div class="mt-10">
        ...
        <ul class="pl-5 list-none">
            ...
            <li>
                <a href="https://insomnia.rest" target="_blank" rel="noopener noreferrer">💾 HeidiSQL</a>
            ...
            <li>
                ...
                <span>My favorite browser for personal use and development/testing, but I’m also using Firefox
                    occasionally</span>
            </li>
            <li>
                <svg class="inline" width="18" height="18" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="mt-10">
        ...
        <ul class="pl-5 list-none">
            ...
            <li>
                ...
                <span>For work and for talking with friends and colleagues. Primary means of communication</span>
            </li>
            <li>
    ...
    <div class="mt-10">
        ...
        <ul class="pl-5 list-none">
            ...
            <li>
                🗒 <a href="https://habitica.com/" target="_blank" rel="noopener noreferrer">Habitica</a>
            ...
            <li>
                <a href="https://www.adobe.com/products/xd.html" target="_blank" rel="noopener noreferrer">🎨 Adobe
                    XD</a>
                <span>To view designs created by customers.</span>
            </li>
            <li>
                <a href="https://www.adobe.com/products/xd.html" target="_blank" rel="noopener noreferrer">🐛 Sentry</a>
...
<section>
    ...
    <ul class="list-none">
        ...
        <li>
            Motherboard:
            <a href="https://www.msi.com/Motherboard/MPG-Z490-GAMING-PLUS" target="_blank">MSI MPG Z490 Gaming Plus</a>
        </li>
        <li>
            PSU:
