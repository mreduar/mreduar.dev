...
- Systems that look correct but **collapse** under slightly more load than usual.
- Code that passes the tests but is **impossible to scale**.
- Pull requests that nobody understands because **nobody actually wrote them**.
